...
class ExperimentTracker {
	...
	stopTimer() {
		...
		this.trials.push([this.trial, this.attempt, this.menuType, this.menuDepth, this.nemuBreadth, this.inputDevice, this.targetItem, this.selectedItem, this.startTime, this.endTime])
		this.resetTimers();
		this.attempt++;
