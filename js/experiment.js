...
const trialsFile = "./data/experiments_breadth_1.csv"
const menuL1File = "./data/menu_depth_1_breadth_1.csv"
const menuL2File = "./data/menu_depth_2_breadth_1.csv"
const menuL3File = "./data/menu_depth_3_breadth_1.csv"
